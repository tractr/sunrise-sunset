 ...
 * Default zenith
 */
export const OFFICIAL_ZENITH = 90.8333;
...
function calculate(
  ...
  if (cosLocalHourAngle > 1)
    throw new SunNeverRisesError(
      'Sun is never rises for this location and specific date'
    );
  if (cosLocalHourAngle < -1)
    throw new SunNeverSetsError(
      'Sun is never sets for this location and specific date'
    );
